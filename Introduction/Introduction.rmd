...
- You will have to work on a final group project which focus on one or more of the topics discussed in the course. 
...
- R is highly extensible. A massive set of packages for statistical modelling, machine learning, visualisation, as well as importing and manipulating data. Researchers in statistics and machine learning will often publish an R package to accompany their articles.
...
The chances are high that somebody else has already asked the same questions and it has already been solved. 
