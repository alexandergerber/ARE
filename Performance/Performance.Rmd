...
- Futures can by evaluated asynchronously in a seperate process, i.e. they do not block the 'main' process which is available for further processing so that other computations can be run in the meantime
...
The unknown parameters $\pi, \mu_1,\mu_2,\sigma_1,\sigma_2$ are estimated by maximum likelihood methods. 

$$\log f(x\vert\pi,\boldsymbol{\mu},\boldsymbol{\sigma}) = $$
