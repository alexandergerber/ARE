...
4. Use a simple linear regression model and a qutratic regression model for smoothing.  
...
---
<ol start="4">
<li>Repreoduce the plot created by the following code with <TT>ggplot</TT>.</li>
