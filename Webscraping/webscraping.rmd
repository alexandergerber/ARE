...
Consider the website https://www.trustpilot.com/review/www.amazon.com which offers customer
for online shops consisting of
- a short text
- a date
...
If we want to select all paragraphs (`p`) which are a decendent of an element with class `.red` we can do
