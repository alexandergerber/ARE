...
```
````
- We are using CSS to style our table. See the [kableExtra vignette](https://cran.r-project.org/web/packages/kableExtra/vignettes/awesome_table_in_html.html)
...
- To include figures saved on your computer
...
3. Optimize your code chunks so that the document doesn't load the data every time you compile. Also hide all your code chunks. 

4. Use the second section to summarize the data. You are free to do whatever you like but produce at least one table and one graphic. 
