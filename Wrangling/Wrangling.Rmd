...
- `separate()` takes a single column and tuns it into multiple columns based on a separator.  
...
Each observation is in one row and each variable is one cloumn. 
...
---
### Case Study
Prepare the trade data set which contains multiple tables for an analysis. 
Use the techniques you learnt so far to get some insight into the trading relationship between the USA and Germany. 
